describe('Campaign Create Spec' , function(){
                    beforeAll(function () {
                    browser.sleep(300000);  // wait for 2 minutes
                    });
           ...
           it('should create a charity campaign' , function(){
                   ...
                   browser.sleep(3000);
                   expect(element(by.css('#fundraising-app-holder > div > create-campaign > div > div.container-fluid.customTabContent.campaignDetail.createCampaign > div > div > campaign-overview > div.container.form.createCampaign > div > form > div > div > div:nth-child(6) > div > div:nth-child(2) > div > auto-complete-widget > div > div > div > li > a')).isPresent()).toBe(false);
                   element(by.cssContainingText('span','Create')).click();           
                   });
