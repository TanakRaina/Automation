...
describe('Check donation using search for campaign' , function(){
   ...
   it('should enter donation amount details' , function(){
                ...
                browser.findElement(by.css('#modalId > div > div > div:nth-child(2) > div > donate-modal > div > div.donationAmountSec > div:nth-child(2) > div > div > span.tipInfo > input')).click().then(function(){
  ...
  it('should match total donation amount',function(){
      ...
      var total_amount = (donation_value + ((tip_value)/100)*donation_value);
                ...
                expect(element(by.css('.totalAmount strong'))).toContain(str_value);  */
                 ...
                 expect(element(by.css('.totalAmount strong'))).toContain(browser.params.total_amount_value);
...
it('should add donation details',function(){
             ...
             /*   browser.driver.findElement(by.id('cardNumberInput')).then(function(present){
                ...
                element(by.id('emailInput')).isPresent().then(function(present){
                if(present == true){
